...
?>
                    ...
                    <h2 id="sec0">Employé de contact</h2>
                    <p>
                        Jeannot Antoine
                    </p>
                    ...
                    <h2 id="sec1">Contributeurs externes</h2>
                    <p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading"><h3>Adrien Hubner</h3></div>
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default">
                                <div class="panel-heading"><h3>Alaric Hadef.</h3></div>
                                <div class="panel-body">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis pharetra varius quam sit amet vulputate. 
                                    Quisque mauris augue, molestie tincidunt condimentum vitae, gravida a libero. Aenean sit amet felis 
                                    dolor, in sagittis nisi. Sed ac orci quis tortor imperdiet venenatis. Duis elementum auctor accumsan. 
                                    Aliquam in felis sit amet augue.
                    ...
                    <h2 id="sec2">Organismes projets</h2>
                    ...
                    <h2 id="sec3">Créer un organisme projet</h2>
                    <p>
                    ...
                    <h2 id="sec4">Propositions de projet labelisées</h2>
                    <p>
