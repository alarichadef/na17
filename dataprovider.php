...
function getProjects()
{
	$db = dpconnexion();
	$query =
		@"select projet.id as i, projet.debut as d, projet.fin as f, description as de, projet.proposition p from projet,proposition_de_projet, appel_a_projet where projet.proposition = proposition_de_projet.id and proposition_de_projet.appel_a_projet = appel_a_projet.id";
